...
# Config validators, ported from Hikka (https://github.com/hikariatama/Hikka)
import functools
import re
import typing
    ...
    def _validate(
        ...
        *,
        ...
        if (
            ...
            and len(utils.graphemes(str(value))) != length
        ):
            raise ValidationError(
        ...
        if (
            ...
            and len(utils.graphemes(str(value))) < min_len
        ):
            raise ValidationError(
        ...
        if (
            ...
            and len(utils.graphemes(str(value))) > max_len
        ):
            raise ValidationError(
...
class Emoji(Validator):
    ...
    :param length: Number of emojis to be passed
    ...
    def _validate(
        ...
        *,
        ...
        value = str(value)
        graphemes = utils.graphemes(value)
        passed_length = len(graphemes)
        ...
        if not value or any(not utils.is_emoji(emoji) for emoji in graphemes):
            raise ValidationError(
